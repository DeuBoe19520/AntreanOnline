...
public class AntreTidakLangsungActivity extends AppCompatActivity implements View.OnClickListener {
  ...
  AppCompatEditText editPekerjaan;
  AppCompatEditText editNIK;
  AppCompatEditText editAlamat;
  AppCompatEditText editTanggalPengurusan;
  AppCompatEditText editNomorWhatsApp;
  AppCompatEditText editNamaDiwakilkan;
  AppCompatEditText editTanggalLahirDiwakilkan;
  AppCompatEditText editPekerjaanDiwakilkan;
  AppCompatEditText editNIKDiwakilkan;
  AppCompatEditText editAlamatDiwakilkan;
  ContentLoadingProgressBar progressBar;
  AppCompatButton buttonKumpulkan;
  AppCompatButton buttonTambah;
  private String nama;
  private String tanggalLahir;
  private String pekerjaan;
  private String NIK;
  private String alamat;
  private String tanggalPengurusan;
  private String nomorWhatsApp;
  private String layanan;
  private String namaDiwakilkan;
  private String tanggalLahirDiwakilkan;
  private String pekerjaanDiwakilkan;
  private String NIKDiwakilkan;
  private String alamatDiwakilkan;
  private final String DATE_PICKER = "DATE_PICKER";
  public static final int REQUEST_PDF = 2;
  private MaterialDatePicker pengurusanDatePicker;
  private MaterialDatePicker lahirDatePicker;
  private MaterialDatePicker lahirDiwakilkanDatePicker;
  ...
  private void finalUpload() {
    for (int i = 0; i < uriList.size(); i++) {
      ...
      StorageReference fileReference = mStorageReference
          .child("D" + key + i + "." + getFileExtension(praFile));
